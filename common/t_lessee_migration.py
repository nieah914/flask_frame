...
VALUES        
(
CASE WHEN '{0}' = 'None' THEN null ELSE '{0}'END,  -- 권역
CASE WHEN '{1}' = 'None' THEN null ELSE '{1}'END,  -- 빌딩명
CASE WHEN '{2}' = 'None' THEN null ELSE '{2}'END,  -- 호수
CASE WHEN '{3}' = 'None' THEN null ELSE '{3}'END,  -- 상호
CASE WHEN '{4}' = 'None' THEN null ELSE '{4}'END,  -- 업종1
CASE WHEN '{5}' = 'None' THEN null ELSE '{5}'END,  -- 업종2
CASE WHEN '{6}' = 'None' THEN null ELSE '{6}'END, -- 보증금
CASE WHEN '{7}' = 'None' THEN null ELSE '{7}'END, -- 월세
CASE WHEN '{8}' = 'None' THEN null ELSE '{8}'END, -- 권리금
getdate(),
getdate(),
'ADMIN',
'C',
